...
query = '("Retrieval Augmented Generation" OR RAG OR "Large Language Model" OR ChatGPT OR GPT-4 OR GPT) AND ("Skin Cancer" OR Melanoma OR "Squamous Cell Carcinoma" OR "Basal Cell Carcinoma") AND ("2023"[Date - Publication] : "3000"[Date - Publication])'
